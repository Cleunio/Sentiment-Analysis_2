# -*- coding: utf-8 -*-
"""New Project Sentiment_Analysis _.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/12uCJ76HL148a364VY0hW18tBBoy-lZwo
"""
...
prev_final = []
for prev in prev_:
  if prev['Positive'] > prev['Negative']
    prev_final.append('Positive')
  else:
    prev_final.append('Negative')

prev_final= np.array(prev_final)

answer_real = dataset['sentiment'].values
